---
name: art-direction
description: The Stencil + Frame art direction system — locked Process-as-Provenance territory, the three visual registers, style DNA prompt block, anchor set, production pipeline, known drift directions, and the approved 8-device library. Use for any Stencil + Frame visual asset decision. For brand-agnostic art direction process, use art-directing-web instead.
---
